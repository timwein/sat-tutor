      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex flex-wrap items-end gap-3">
          <div className="min-w-56 space-y-1">
            <label htmlFor="gen-skill" className="text-xs font-medium text-gray-600 dark:text-gray-300">
              Sub-skill
            </label>
          ...
          <div className="space-y-1">
            <label htmlFor="gen-count" className="text-xs font-medium text-gray-600 dark:text-gray-300">
              How many
            </label>
